...
**Generated by**: [Windsurf/Roo Code/KiloCode/Other] **Prompt used**: [Reference
to prompt template or custom prompt] **Human oversight**: [Level of human
review/modification]
...
**Expected performance change**: [Better/Same/Worse - with details] **Benchmarks
run**: [Yes/No - include results if available]
...
**AI accuracy**: [High/Medium/Low] - [Brief explanation] **Human modifications
made**: [None/Minor/Major] - [What was changed] **Confidence level**:
[High/Medium/Low] in this implementation
...
3. **Questions for Discussion**: [Any areas where feedback is specifically
   needed]
